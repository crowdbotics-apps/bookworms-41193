"""
Django settings for bookworms_41193 project.
...
ROOT_URLCONF = 'bookworms_41193.urls'
...
WSGI_APPLICATION = 'bookworms_41193.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bookworms_41193 API",
    "DESCRIPTION": "API documentation for bookworms_41193 App",
    "VERSION": "v1",
}
